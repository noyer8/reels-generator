...
import { ReelImmobilierBlur } from './ReelImmobilierBlur';
...
export const RemotionRoot = () => {
  return (
    <>
      {/* Template par défaut - Photos en plein écran (crop) */}
      <Composition
        id="ReelImmobilier"
      ...
      {/* Template Blur - Photos en paysage avec fond flou */}
      <Composition
        id="ReelImmobilierBlur"
        component={ReelImmobilierBlur}
        durationInFrames={FPS * SCENE_DURATION * TOTAL_SCENES}
        fps={FPS}
        width={1080}
        height={1920}
